...
public class Scheduler {
	...
	private static boolean initializeFromInputFile(String resourceListFile) {
		...
		File inputFile = new File(resourceListFile);
		//initialize user data file
		try {
			scanner = new Scanner(inputFile);
			String line = scanner.nextLine();
			String tmp = "";//use to store resource name
			...
			while(scanner.hasNextLine()){
				...
				if(line.contains("#Resource: ")){
					...
					resourceName=line;
					tmp = resourceName;
					boolean a=schedulerDB.addResource(resourceName);
					line=scanner.nextLine();
					continue;
				} 
				else{
				...
				//read start time
				line=scanner.nextLine();
				start = convertToTime(line);
				//read end time
				line=scanner.nextLine();
				end = convertToTime(line);
				...
				desc=line;
				resourceName = tmp;
				schedulerDB.addEvent(resourceName, start, end, name, orgname, desc);
